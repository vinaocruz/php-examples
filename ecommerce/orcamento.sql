...
INSERT INTO `cidades` (`estado_id`, `id`, `nome`, `cep`) VALUES
...
ALTER TABLE `enderecos`
  ADD CONSTRAINT `enderecos_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `cliente` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
